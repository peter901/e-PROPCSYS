<div class="dragable" id="input_custom">Custom Element (HTML/PHP)</div>
<div class="element_code" id="input_custom_element">
	<label for="<?php echo $element_params['input_id']; ?>" id="input_custom_{n}_label" class="custom_label updatable_label"><?php echo $element_params['label_text']; ?></label>
...
<div class="element_config" id="input_custom_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('general'); ?>
		...
		<?php echo $HtmlHelper->input('input_custom_{n}_clean_config', array('type' => 'checkbox', 'label' => 'Pure code', 'class' => 'small_input', 'value' => '1', 'rule' => "bool", 'smalldesc' => 'Should the code be rendered without being included inside any containers ?')); ?>
