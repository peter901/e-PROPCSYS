<div class="dragable" id="input_header">Formatted Text</div>
<div class="element_code" id="input_header_element">
	<?php if(empty($element_params['code'])): ?><label id="input_header_{n}_label" class="header_label updatable_label">Header</label><?php endif; ?>
