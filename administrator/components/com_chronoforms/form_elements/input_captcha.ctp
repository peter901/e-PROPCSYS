...
<div class="element_code" id="input_captcha_element">
	<label for="<?php echo $element_params['input_id']; ?>" id="input_captcha_{n}_label" class="text_label updatable_label"><?php echo $element_params['label_text']; ?></label>
...
<div class="element_config" id="input_captcha_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('general'); ?>
		...
		<?php echo $HtmlHelper->input('input_captcha_{n}_input_name_config', array('type' => 'text', 'disabled' => 'true', 'label' => 'Field Name', 'class' => 'small_input', 'value' => '', 'smalldesc' => 'No spaces or any special characters, underscores allowed.')); ?>
		<?php echo $HtmlHelper->input('input_captcha_{n}_input_title_config', array('type' => 'text', 'label' => 'Field Title', 'class' => 'small_input', 'value' => '', 'smalldesc' => 'Change this to override the default JS validation error message.')); ?>
