...
<thead>
	...
	<th width="1%" class='title' style="text-align: left;"><input type="checkbox" name="toggle" value="" onclick="Joomla.checkAll(this)" /></th>
	<?php endif; ?>
	...
	<?php foreach($table_data as $row): ?>
		<tr>
			...
			<td width="1%" class='title'>
				<input type="checkbox" id="cb<?php echo $i;?>" name="cid[]" value="<?php echo $row->$primary; ?>" onclick="Joomla.isChecked(this.checked);" />
			</td>
			<?php endif; ?>
