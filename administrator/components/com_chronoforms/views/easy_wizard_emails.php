...
<ul class="nav nav-tabs">
	<li class="active"><a href="#emails_email_10" data-toggle="tab">Email #1</a></li>
	<li><a href="#emails_email_11" data-toggle="tab">Email #2</a></li>
	<li><a href="#emails_email_12" data-toggle="tab">Email #3</a></li>
</ul>
<?php
...
?>
<?php for($i = 10; $i <= 12; $i++): ?>
<?php echo '<div class="tab-pane'.($email_c == 1 ? ' active' : '').'" id="emails_email_'.$i.'">'; ?>
