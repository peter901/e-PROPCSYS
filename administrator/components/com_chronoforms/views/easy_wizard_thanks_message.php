...
<ul class="nav nav-tabs">
	<li class="active"><a href="#thanks_message_<?php echo $i; ?>" data-toggle="tab">Your thanks message</a></li>
</ul>
<?php echo '<div class="tab-content">'; ?>
<?php echo '<div class="tab-pane'.(true ? ' active' : '').'" id="thanks_message_'.$i.'">'; ?>
