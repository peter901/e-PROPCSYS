...
var SqueezeBox = {
	...
	build: function() {
		...
		//this.closeBtn = new Element('a', {id: 'sbox-btn-close', href: '#'}).inject(this.win);//hack below
		this.closeBtn = new Element('span', {id: 'sbox-btn-close', style: 'cursor:pointer'}).inject(this.win);
		this.fx = {
	...
	toggleListeners: function(state) {
		...
		//this.overlay[fn]('click', this.bound.close);//hack
