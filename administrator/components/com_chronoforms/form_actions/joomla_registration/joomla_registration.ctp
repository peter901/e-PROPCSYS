...
<div class="element_code" id="cfaction_joomla_registration_element">
	...
	<input type="hidden" name="chronoaction[{n}][action_joomla_registration_{n}_activation_link]" id="action_joomla_registration_{n}_activation_link" value="<?php echo $action_params['activation_link']; ?>" />
	<input type="hidden" name="chronoaction[{n}][action_joomla_registration_{n}_user_data_path]" id="action_joomla_registration_{n}_user_data_path" value="<?php echo $action_params['user_data_path']; ?>" />
...
<div class="element_config" id="cfaction_joomla_registration_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('settings'); ?>
		...
		<?php echo $HtmlHelper->input('action_joomla_registration_{n}_activation_link_config', array('type' => 'text', 'label' => 'Activation Link', 'class' => 'big_input', 'smalldesc' => 'Use this ONLY if your "Allow User Registration" is set to "NO" in the Joomla Users Manager, add a link to a form event with the "Joomla User Activation" action.')); ?>
		...
		<?php echo $HtmlHelper->input('action_joomla_registration_{n}_user_data_path_config', array('type' => 'text', 'label' => 'User Data Path', 'class' => 'medium_input', 'smalldesc' => 'The data array path under which the created user data will be set.')); ?>
