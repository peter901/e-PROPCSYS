...
<div class="element_code" id="cfaction_db_save_element">
	...
	<input type="hidden" name="chronoaction[{n}][action_db_save_{n}_params_fields]" id="action_db_save_{n}_params_fields" value="<?php echo $action_params['params_fields']; ?>" />
...
<div class="element_config" id="cfaction_db_save_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('basic'); ?>	
		...
		<?php echo $HtmlHelper->input('action_db_save_{n}_params_fields_config', array('type' => 'text', 'label' => "Parameters Fields", 'class' => 'big_input', 'smalldesc' => "List of form fields names which will be treated as Joomla Parameters fields when processed, those fields should be always of type Array, leave empty if you don't know how to use this.")); ?>
