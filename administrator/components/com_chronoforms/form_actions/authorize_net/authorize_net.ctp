...
<div class="element_code" id="cfaction_authorize_net_element">
	...
	<input type="hidden" name="chronoaction[{n}][action_authorize_net_{n}_auto_add_error]" id="action_authorize_net_{n}_auto_add_error" value="<?php echo $action_params['auto_add_error']; ?>" />
...
<div class="element_config" id="cfaction_authorize_net_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('settings'); ?>
		...
		<?php echo $HtmlHelper->input('action_authorize_net_{n}_auto_add_error_config', array('type' => 'select', 'label' => 'Auto Set Error', 'options' => array(0 => 'No', 1 => 'Yes'))); ?>
