...
--
-- Host: localhost
-- Generation Time: Oct 31, 2013 at 01:18 PM
...
-- Database: `e-procsys`
--
CREATE DATABASE IF NOT EXISTS `e-procsys` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `e-procsys`;

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_assets`
--

CREATE TABLE IF NOT EXISTS `c0n4d_assets` (
...
--
-- Dumping data for table `c0n4d_assets`
--

INSERT INTO `c0n4d_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(37, 1, 71, 72, 1, 'com_chronoforms', 'chronoforms', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_associations`
--

CREATE TABLE IF NOT EXISTS `c0n4d_associations` (
...
--
-- Table structure for table `c0n4d_banner_clients`
--

CREATE TABLE IF NOT EXISTS `c0n4d_banner_clients` (
...
--
-- Table structure for table `c0n4d_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `c0n4d_banner_tracks` (
...
--
-- Table structure for table `c0n4d_banners`
--

CREATE TABLE IF NOT EXISTS `c0n4d_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `c0n4d_categories`
--

CREATE TABLE IF NOT EXISTS `c0n4d_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_categories`
--

INSERT INTO `c0n4d_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_chronoform_actions`
--

CREATE TABLE IF NOT EXISTS `c0n4d_chronoform_actions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_chronoform_actions`
--

INSERT INTO `c0n4d_chronoform_actions` (`id`, `chronoform_id`, `type`, `enabled`, `params`, `order`, `content1`) VALUES
(357, 6, 'db_multi_record_loader', 1, '{"dbfield":"","table_name":"c0n4d_chronoforms_data_employee","request_param":"","load_data":"1","load_type":"all","model_id":"employee_details","fields":"","enable_association":"0","join_type":"INNER","join_rule":"","associated_models":"","group_model_data":"1","enable_pagination":"0","pagination_limit":"50","enable_data_displayer":"0","data_display_fields":"","data_order_fields":""}', 0, ''),
(358, 6, 'custom_code', 1, '{"mode":"controller","action_label":"Edit employees"}', 2, '<table>\r\n<tr>\r\n<th>Id</th>\r\n<th>Name</th>\r\n<th>Edit</th>\r\n</tr>\r\n<?php\r\nforeach($form->data[''employee_details''] as $detail):\r\n?>\r\n\r\n<tr>\r\n<td><?php echo $detail[''employee_id'']?>&nbsp;</td>\r\n<td><?php echo $detail[''first_name'']?>&nbsp;</td>\r\n<td><a href="index.php?option=com_chronoforms&chronoform=Employee&token=<?php echo $detail[''cf_uid'']?>">Edit</a></td>\r\n</tr>\r\n<?php\r\nendforeach;\r\n?>\r\n</table>'),
(555, 4, 'custom_code', 1, '{"mode":"controller","action_label":""}', 2, 'No items found'),
(556, 4, 'show_stopper', 1, '[]', 3, ''),
(557, 4, 'db_multi_record_loader', 1, '{"dbfield":"","table_name":"c0n4d_chronoforms_data_department","request_param":"","load_data":"1","load_type":"all","model_id":"data_department","fields":"","enable_association":"0","join_type":"INNER","join_rule":"","associated_models":"","group_model_data":"1","enable_pagination":"0","pagination_limit":"50","enable_data_displayer":"1","data_display_fields":"","data_order_fields":""}', 1, '1=1 ORDER BY dept_id'),
(558, 4, 'custom_code', 1, '{"mode":"controller","action_label":""}', 4, '<table>\r\n<tr>\r\n<th>Id</th>\r\n<th>Name</th>\r\n<th>Edit</th>\r\n</tr>\r\n<?php\r\nforeach($form->data[''data_department''] as $detail):\r\n?>\r\n<tr>\r\n<td><?php echo $detail[''dept_id'']?>&nbsp;</td>\r\n<td><?php echo $detail[''department_name'']?>&nbsp;</td>\r\n<td><a href="index.php?option=com_chronoforms&chronoform=Department&token=<?php echo $detail[''cf_uid'']?>">Edit</a></td>\r\n</tr>\r\n<?php\r\nendforeach;\r\n?>\r\n</table>'),
(559, 3, 'db_multi_record_loader', 1, '{"dbfield":"","table_name":"c0n4d_chronoforms_data_department","request_param":"","load_data":"1","load_type":"all","model_id":"department","fields":"","enable_association":"0","join_type":"INNER","join_rule":"","associated_models":"","group_model_data":"1","enable_pagination":"0","pagination_limit":"50","enable_data_displayer":"0","data_display_fields":"","data_order_fields":""}', 7, '1 ORDER BY ''department_name'''),
(560, 3, 'db_record_loader', 1, '{"dbfield":"cf_uid","table_name":"c0n4d_chronoforms_data_employee","request_param":"token","model_id":"","load_under_modelid":"0","array_fields_sets":"","array_separators":"","params_fields":""}', 9, ''),
(561, 3, 'show_html', 1, '{"data_republish":"1","display_errors":"1","curly_replacer":"1","load_token":"1","keep_alive":"0","submit_event":"submit","page_number":"1","form_container":""}', 0, ''),
(562, 3, 'db_save', 1, '{"table_name":"c0n4d_chronoforms_data_employee","model_id":"chronoform_data","save_under_modelid":"0","params_fields":"","ndb_enable":"0","ndb_driver":"mysql","ndb_host":"localhost","ndb_user":"","ndb_password":"","ndb_database":"","ndb_table_name":"","ndb_prefix":"jos_"}', 1, ''),
(563, 3, 'redirect_user', 1, '{"target_url":"index.php\\/employee\\/edit-employee"}', 11, ''),
(564, 5, 'db_multi_record_loader', 1, '{"dbfield":"","table_name":"c0n4d_chronoforms_data_department","request_param":"","load_data":"0","load_type":"all","model_id":"department_details","fields":"department_name","enable_association":"0","join_type":"LEFT","join_rule":"`employee_details`.`dept_id` =`department_details`.`dept_id`","associated_models":"employee_details","group_model_data":"0","enable_pagination":"0","pagination_limit":"50","enable_data_displayer":"0","data_display_fields":"","data_order_fields":""}', 2, ''),
(565, 5, 'db_multi_record_loader', 1, '{"dbfield":"","table_name":"c0n4d_chronoforms_data_employee","request_param":"","load_data":"1","load_type":"all","model_id":"employee_details","fields":"employee_id,first_name","enable_association":"1","join_type":"LEFT","join_rule":"","associated_models":"department_details","group_model_data":"0","enable_pagination":"0","pagination_limit":"50","enable_data_displayer":"1","data_display_fields":"employee_id:ID,first_name:Name,department_details.department_name:Department","data_order_fields":""}', 0, '1=1 ORDER BY employee_id'),
(566, 2, 'db_record_loader', 1, '{"dbfield":"cf_uid","table_name":"c0n4d_chronoforms_data_department","request_param":"token","model_id":"","load_under_modelid":"0","array_fields_sets":"","array_separators":"","params_fields":""}', 4, ''),
(567, 2, 'show_html', 1, '{"data_republish":"1","display_errors":"1","curly_replacer":"1","load_token":"1","keep_alive":"0","submit_event":"submit","page_number":"1","form_container":""}', 0, ''),
(568, 2, 'db_save', 1, '{"table_name":"c0n4d_chronoforms_data_department","model_id":"chronoform_data","save_under_modelid":"0","params_fields":"","ndb_enable":"0","ndb_driver":"mysql","ndb_host":"localhost","ndb_user":"","ndb_password":"","ndb_database":"","ndb_table_name":"","ndb_prefix":"jos_"}', 2, ''),
(569, 2, 'redirect_user', 1, '{"target_url":"index.php\\/department\\/list-departments"}', 6, '');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_chronoforms`
--

CREATE TABLE IF NOT EXISTS `c0n4d_chronoforms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_chronoforms`
--

INSERT INTO `c0n4d_chronoforms` (`id`, `name`, `form_type`, `content`, `wizardcode`, `events_actions_map`, `params`, `published`, `app`) VALUES
(2, 'Department', 1, '<div class="ccms_form_element cfdiv_text" id="dept_id_container_div" style=""><label for="dept_id">Dept Id *</label><input id="dept_id" maxlength="150" size="30" class=" validate[''required'']" title="" type="text" value="" name="dept_id" />\n<div class="clear"></div><div id="error-message-dept_id"></div></div><div class="ccms_form_element cfdiv_text" id="department_name_container_div" style=""><label for="department_name">Department Name *</label><input id="department_name" maxlength="150" size="30" class=" validate[''required'']" title="" type="text" value="" name="department_name" />\n<div class="clear"></div><div id="error-message-department_name"></div></div><input type="hidden" value="" name="cf_id" />\n<div class="ccms_form_element cfdiv_submit" id="input_submit_31_container_div" style="text-align:left"><input name="input_submit_3" class="" value="Submit" type="submit" />\n<div class="clear"></div><div id="error-message-input_submit_3"></div></div><div class="ccms_form_element cfdiv_empty" id="empty_container_div" style=""><div class="clear"></div><div id="error-message-empty"></div></div>', 'array (\n  ''field_4'' => \n  array (\n    ''input_text_4_input_id'' => ''dept_id'',\n    ''input_text_4_label_text'' => ''Dept Id *'',\n    ''input_text_4_input_name'' => ''dept_id'',\n    ''input_text_4_input_value'' => '''',\n    ''input_text_4_input_maxlength'' => ''150'',\n    ''input_text_4_input_size'' => ''30'',\n    ''input_text_4_input_class'' => '''',\n    ''input_text_4_input_title'' => '''',\n    ''input_text_4_label_over'' => ''0'',\n    ''input_text_4_hide_label'' => ''0'',\n    ''input_text_4_multiline_start'' => ''0'',\n    ''input_text_4_multiline_add'' => ''0'',\n    ''input_text_4_validations'' => ''required'',\n    ''input_text_4_instructions'' => '''',\n    ''input_text_4_tooltip'' => '''',\n    ''tag'' => ''input'',\n    ''type'' => ''text'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_1'' => \n  array (\n    ''input_text_1_input_id'' => ''department_name'',\n    ''input_text_1_label_text'' => ''Department Name *'',\n    ''input_text_1_input_name'' => ''department_name'',\n    ''input_text_1_input_value'' => '''',\n    ''input_text_1_input_maxlength'' => ''150'',\n    ''input_text_1_input_size'' => ''30'',\n    ''input_text_1_input_class'' => '''',\n    ''input_text_1_input_title'' => '''',\n    ''input_text_1_label_over'' => ''0'',\n    ''input_text_1_hide_label'' => ''0'',\n    ''input_text_1_multiline_start'' => ''0'',\n    ''input_text_1_multiline_add'' => ''0'',\n    ''input_text_1_validations'' => ''required'',\n    ''input_text_1_instructions'' => '''',\n    ''input_text_1_tooltip'' => '''',\n    ''tag'' => ''input'',\n    ''type'' => ''text'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_5'' => \n  array (\n    ''input_hidden_5_input_id'' => '''',\n    ''input_hidden_5_input_name'' => ''cf_id'',\n    ''input_hidden_5_input_value'' => '''',\n    ''input_hidden_5_label_text'' => ''cf_id'',\n    ''tag'' => ''input'',\n    ''type'' => ''hidden'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_3'' => \n  array (\n    ''input_submit_3_input_id'' => '''',\n    ''input_submit_3_input_name'' => ''input_submit_3'',\n    ''input_submit_3_input_value'' => ''Submit'',\n    ''input_submit_3_input_class'' => '''',\n    ''input_submit_3_button_type'' => ''submit'',\n    ''input_submit_3_button_align'' => ''left'',\n    ''input_submit_3_back_button'' => ''0'',\n    ''input_submit_3_reset_button'' => ''0'',\n    ''input_submit_3_back_button_value'' => ''Back'',\n    ''input_submit_3_reset_button_value'' => ''Reset'',\n    ''input_submit_3_back_button_class'' => '''',\n    ''input_submit_3_reset_button_class'' => '''',\n    ''input_submit_3_multiline_start'' => ''0'',\n    ''input_submit_3_multiline_add'' => ''0'',\n    ''tag'' => ''input'',\n    ''type'' => ''submit'',\n    ''container_id'' => ''0'',\n  ),\n)', '', '{"form_mode":"advanced","tight_layout":"1"}', 1, ''),
(3, 'Employee', 1, '<div class="ccms_form_element cfdiv_text" id="employee_id_container_div" style=""><label for="employee_id">Employee ID</label><input id="employee_id" maxlength="150" size="30" class="" title="" type="text" value="" name="employee_id" />\n<div class="clear"></div><div id="error-message-employee_id"></div></div><div class="ccms_form_element cfdiv_text" id="first_name_container_div" style=""><label for="first_name">First name</label><input id="first_name" maxlength="150" size="30" class="" title="" type="text" value="" name="first_name" />\n<div class="clear"></div><div id="error-message-first_name"></div></div><div class="ccms_form_element cfdiv_select" id="dept_id_container_div" style=""><label for="dept_id">Department name</label><select size="1" id="dept_id" class="" title="" name="dept_id">\n\r\n						<?php\r\n						$options_data = $form->get_array_value($form->data, explode(".", "department"));\r\n						if(!is_null($options_data) && is_array($options_data)){\r\n							foreach($options_data as $option_data){\r\n								if(isset($option_data["dept_id"]) && isset($option_data["department_name"])){\r\n									echo ''<option value="''.$option_data["dept_id"].''"''.(in_array($option_data["dept_id"], array (\n  0 => '''',\n)) ? '' selected="selected"'' : "").">".$option_data["department_name"]."</option>\\n";\r\n								}\r\n							}\r\n						}\r\n						?>\r\n						</select>\n<div class="clear"></div><div id="error-message-dept_id"></div></div><input type="hidden" value="" name="cf_id" />\n<div class="ccms_form_element cfdiv_submit" id="input_submit_31_container_div" style="text-align:left"><input name="input_submit_3" class="" value="Submit" type="submit" />\n<div class="clear"></div><div id="error-message-input_submit_3"></div></div><div class="ccms_form_element cfdiv_empty" id="empty_container_div" style=""><div class="clear"></div><div id="error-message-empty"></div></div>', 'array (\n  ''field_1'' => \n  array (\n    ''input_text_1_input_id'' => ''employee_id'',\n    ''input_text_1_label_text'' => ''Employee ID'',\n    ''input_text_1_input_name'' => ''employee_id'',\n    ''input_text_1_input_value'' => '''',\n    ''input_text_1_input_maxlength'' => ''150'',\n    ''input_text_1_input_size'' => ''30'',\n    ''input_text_1_input_class'' => '''',\n    ''input_text_1_input_title'' => '''',\n    ''input_text_1_label_over'' => ''0'',\n    ''input_text_1_hide_label'' => ''0'',\n    ''input_text_1_multiline_start'' => ''0'',\n    ''input_text_1_multiline_add'' => ''0'',\n    ''input_text_1_validations'' => '''',\n    ''input_text_1_instructions'' => '''',\n    ''input_text_1_tooltip'' => '''',\n    ''tag'' => ''input'',\n    ''type'' => ''text'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_2'' => \n  array (\n    ''input_text_2_input_id'' => ''first_name'',\n    ''input_text_2_label_text'' => ''First name'',\n    ''input_text_2_input_name'' => ''first_name'',\n    ''input_text_2_input_value'' => '''',\n    ''input_text_2_input_maxlength'' => ''150'',\n    ''input_text_2_input_size'' => ''30'',\n    ''input_text_2_input_class'' => '''',\n    ''input_text_2_input_title'' => '''',\n    ''input_text_2_label_over'' => ''0'',\n    ''input_text_2_hide_label'' => ''0'',\n    ''input_text_2_multiline_start'' => ''0'',\n    ''input_text_2_multiline_add'' => ''0'',\n    ''input_text_2_validations'' => '''',\n    ''input_text_2_instructions'' => '''',\n    ''input_text_2_tooltip'' => '''',\n    ''tag'' => ''input'',\n    ''type'' => ''text'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_4'' => \n  array (\n    ''input_select_4_input_id'' => ''dept_id'',\n    ''input_select_4_label_text'' => ''Department name'',\n    ''input_select_4_input_name'' => ''dept_id'',\n    ''input_select_4_size'' => ''1'',\n    ''input_select_4_input_class'' => '''',\n    ''input_select_4_input_title'' => '''',\n    ''input_select_4_label_over'' => ''0'',\n    ''input_select_4_hide_label'' => ''0'',\n    ''input_select_4_selected'' => '''',\n    ''input_select_4_showempty'' => '''',\n    ''input_select_4_multiple'' => ''0'',\n    ''input_select_4_multiline_start'' => ''0'',\n    ''input_select_4_multiline_add'' => ''0'',\n    ''input_select_4_enable_dynamic_data'' => ''1'',\n    ''input_select_4_data_path'' => ''department'',\n    ''input_select_4_value_key'' => ''dept_id'',\n    ''input_select_4_text_key'' => ''department_name'',\n    ''input_select_4_options'' => ''No=No\r\nYes=Yes'',\n    ''input_select_4_validations'' => '''',\n    ''input_select_4_instructions'' => '''',\n    ''input_select_4_tooltip'' => '''',\n    ''tag'' => ''input'',\n    ''type'' => ''select'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_5'' => \n  array (\n    ''input_hidden_5_input_id'' => '''',\n    ''input_hidden_5_input_name'' => ''cf_id'',\n    ''input_hidden_5_input_value'' => '''',\n    ''input_hidden_5_label_text'' => ''cf_id'',\n    ''tag'' => ''input'',\n    ''type'' => ''hidden'',\n    ''container_id'' => ''0'',\n  ),\n  ''field_3'' => \n  array (\n    ''input_submit_3_input_id'' => '''',\n    ''input_submit_3_input_name'' => ''input_submit_3'',\n    ''input_submit_3_input_value'' => ''Submit'',\n    ''input_submit_3_input_class'' => '''',\n    ''input_submit_3_button_type'' => ''submit'',\n    ''input_submit_3_button_align'' => ''left'',\n    ''input_submit_3_back_button'' => ''0'',\n    ''input_submit_3_reset_button'' => ''0'',\n    ''input_submit_3_back_button_value'' => ''Back'',\n    ''input_submit_3_reset_button_value'' => ''Reset'',\n    ''input_submit_3_back_button_class'' => '''',\n    ''input_submit_3_reset_button_class'' => '''',\n    ''input_submit_3_multiline_start'' => ''0'',\n    ''input_submit_3_multiline_add'' => ''0'',\n    ''tag'' => ''input'',\n    ''type'' => ''submit'',\n    ''container_id'' => ''0'',\n  ),\n)', '', '{"form_mode":"advanced","tight_layout":"1"}', 1, ''),
(4, 'list_departments', 1, '<div class="ccms_form_element cfdiv_empty" id="empty_container_div" style=""><div class="clear"></div><div id="error-message-empty"></div></div>', 'array (\n)', '', '{"form_mode":"advanced","tight_layout":"1"}', 1, ''),
(5, 'list_employee', 1, '<div class="ccms_form_element cfdiv_empty" id="empty_container_div" style=""><div class="clear"></div><div id="error-message-empty"></div></div>', 'array (\n)', '', '{"form_mode":"advanced","tight_layout":"0"}', 1, ''),
(6, 'edit_employee', 1, '<div class="ccms_form_element cfdiv_empty" id="empty_container_div" style=""><div class="clear"></div><div id="error-message-empty"></div></div>', 'array (\n)', '', '{"form_mode":"advanced","tight_layout":"1"}', 1, '');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_chronoforms_data_department`
--

CREATE TABLE IF NOT EXISTS `c0n4d_chronoforms_data_department` (
...
--
-- Dumping data for table `c0n4d_chronoforms_data_department`
--

INSERT INTO `c0n4d_chronoforms_data_department` (`cf_id`, `cf_uid`, `cf_created`, `cf_modified`, `cf_created_by`, `cf_modified_by`, `cf_ipaddress`, `cf_user_id`, `dept_id`, `department_name`) VALUES
(1, '05b456ee78fc8479a07082215a292ea8', '2013-10-28 17:33:30', '2013-10-29 18:31:18', 0, 0, '::1', 0, '4', 'Information Technology'),
(2, 'dd6af06642d7ae1dd27cc0dd7e3193a6', '2013-10-28 17:33:57', '2013-10-29 18:48:24', 0, 0, '::1', 0, '1', 'Finance'),
(3, '138405da1ff8aa64db34ba4b7ca3cdb6', '2013-10-28 17:34:08', '2013-10-29 18:30:54', 0, 0, '::1', 0, '2', 'Exams'),
(4, '673992d065774b7126acb8fb4f5478d3', '2013-10-28 17:34:21', '2013-10-29 18:31:04', 0, 0, '::1', 0, '3', 'Technical'),
(5, 'd01937319d8a63ab8fd8e05804cf6aa0', '2013-10-28 17:34:32', '2013-10-29 18:31:23', 0, 0, '::1', 0, '5', 'Accounts'),
(6, '3349dd50367a1bd2aec5c011284469fb', '2013-10-28 17:34:49', '2013-10-29 18:31:29', 0, 0, '::1', 0, '6', 'Public Relations'),
(7, 'f77e982cc2554c379dc6cf775c337acd', '2013-10-28 20:22:54', '2013-10-29 18:31:51', 0, 0, '::1', 0, '7', 'Credit Control'),
(8, '2b94816ad4755529e128578fbf8bad71', '2013-10-28 20:31:28', '2013-10-29 18:48:42', 0, 0, '::1', 0, '8', 'Procurement'),
(9, 'ee6fb2965f7a93fff3a4f80140ac3f92', '2013-10-28 20:34:15', '2013-10-28 23:25:22', 0, 0, '::1', 0, '9', 'ISP');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_chronoforms_data_employee`
--

CREATE TABLE IF NOT EXISTS `c0n4d_chronoforms_data_employee` (
  `cf_id` int(11) NOT NULL AUTO_INCREMENT,
  `cf_uid` varchar(255) NOT NULL,
  `cf_created` datetime NOT NULL,
  `cf_modified` datetime NOT NULL,
...
--
-- Dumping data for table `c0n4d_chronoforms_data_employee`
--

INSERT INTO `c0n4d_chronoforms_data_employee` (`cf_id`, `cf_uid`, `cf_created`, `cf_modified`, `cf_created_by`, `cf_modified_by`, `cf_ipaddress`, `cf_user_id`, `employee_id`, `first_name`, `dept_id`, `submit`) VALUES
(2, 'b5d00169066c27052bbcd0a706f3fb3b', '2013-10-28 18:21:30', '2013-10-28 23:28:39', 0, 0, '::1', 0, '1', 'Tom Sanyu', '8', ''),
(3, '23ac051f681dfa93ff97d949f20fcc50', '2013-10-28 18:28:07', '2013-10-29 17:34:36', 0, 0, '::1', 0, '2', 'Sarah Kazibwe', '2', ''),
(4, 'f85be1b25d19d4ec7b10695f8b089622', '2013-10-28 18:29:08', '2013-10-29 18:07:08', 0, 0, '::1', 0, '3', 'Timothy Kavuma', '4', ''),
(5, 'f0d192f1d36d95ed0b488900fdd66c77', '2013-10-28 18:33:04', '2013-10-29 17:35:13', 0, 0, '::1', 0, '4', 'Zack Barigye', '3', ''),
(6, 'd14e289f067cf643b337e3647e24571a', '2013-10-28 20:33:21', '2013-10-29 17:55:47', 0, 0, '::1', 0, '5', 'Suzan Esther', '3', ''),
(10, 'c3f8b85bfe18ca9e6e335f2f2359872d', '2013-10-29 17:52:42', '0000-00-00 00:00:00', 0, 0, '::1', 0, '6', 'Samson Kiseka', '4', ''),
(11, '5a326931401d809a8019178a3a345d93', '2013-10-31 13:18:05', '0000-00-00 00:00:00', 500, 0, '::1', 500, '6', 'John Ssentamu', '6', '');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_contact_details`
--

CREATE TABLE IF NOT EXISTS `c0n4d_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `c0n4d_content`
--

CREATE TABLE IF NOT EXISTS `c0n4d_content` (
...
--
-- Table structure for table `c0n4d_content_rating`
--

CREATE TABLE IF NOT EXISTS `c0n4d_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `c0n4d_content_types`
--

CREATE TABLE IF NOT EXISTS `c0n4d_content_types` (
...
--
-- Dumping data for table `c0n4d_content_types`
--

INSERT INTO `c0n4d_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`) VALUES
...
--
-- Table structure for table `c0n4d_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `c0n4d_contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `c0n4d_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `c0n4d_core_log_searches` (
...
--
-- Table structure for table `c0n4d_extensions`
--

CREATE TABLE IF NOT EXISTS `c0n4d_extensions` (
...
--
-- Dumping data for table `c0n4d_extensions`
--

INSERT INTO `c0n4d_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10000, 'chronoforms', 'component', 'com_chronoforms', '', 1, 1, 0, 0, '{"name":"ChronoForms","type":"component","creationDate":"7.October.2013","author":"Chronoman","copyright":"ChronoEngine.com 2013","authorEmail":"webmaster@chronoengine.com","authorUrl":"www.chronoengine.com","version":"4.0.2","description":"Create everytype of Forms with whatever features you like!!","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_finder_filters`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_filters` (
...
--
-- Table structure for table `c0n4d_finder_links`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links` (
...
--
-- Table structure for table `c0n4d_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms0` (
...
--
-- Table structure for table `c0n4d_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `c0n4d_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `c0n4d_finder_taxonomy`
--

INSERT INTO `c0n4d_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `c0n4d_finder_terms`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_terms` (
...
--
-- Table structure for table `c0n4d_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `c0n4d_finder_terms_common`
--

INSERT INTO `c0n4d_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `c0n4d_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `c0n4d_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `c0n4d_finder_types`
--

CREATE TABLE IF NOT EXISTS `c0n4d_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `c0n4d_languages`
--

CREATE TABLE IF NOT EXISTS `c0n4d_languages` (
...
--
-- Dumping data for table `c0n4d_languages`
--

INSERT INTO `c0n4d_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_menu`
--

CREATE TABLE IF NOT EXISTS `c0n4d_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_menu`
--

INSERT INTO `c0n4d_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(466, 'main', 'COM_CHRONOFORMS', 'com-chronoforms', '', 'com-chronoforms', 'index.php?option=com_chronoforms', 'component', 0, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_chronoforms/CF.png', 0, '', 223, 232, 0, '', 1),
(467, 'main', 'COM_CHRONOFORMS_FORMS_MANAGER', 'com-chronoforms-forms-manager', '', 'com-chronoforms/com-chronoforms-forms-manager', 'index.php?option=com_chronoforms', 'component', 0, 466, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 224, 225, 0, '', 1),
(468, 'main', 'COM_CHRONOFORMS_WIZARD', 'com-chronoforms-wizard', '', 'com-chronoforms/com-chronoforms-wizard', 'index.php?option=com_chronoforms&task=form_wizard', 'component', 0, 466, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 226, 227, 0, '', 1),
(469, 'main', 'COM_CHRONOFORMS_EASY_WIZARD', 'com-chronoforms-easy-wizard', '', 'com-chronoforms/com-chronoforms-easy-wizard', 'index.php?option=com_chronoforms&task=form_wizard&wizard_mode=easy', 'component', 0, 466, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 228, 229, 0, '', 1),
(470, 'main', 'COM_CHRONOFORMS_VALIDATE', 'com-chronoforms-validate', '', 'com-chronoforms/com-chronoforms-validate', 'index.php?option=com_chronoforms&task=validatelicense', 'component', 0, 466, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 230, 231, 0, '', 1),
(471, 'mainmenu', 'Employee', 'employee', '', 'employee', 'index.php?option=com_chronoforms&view=form', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"formname":"list_employee","event":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 233, 238, 1, '*', 0),
(472, 'mainmenu', 'Department', 'department', '', 'department', 'index.php?option=com_chronoforms&view=form', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"formname":"list_departments","event":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 239, 242, 0, '*', 0),
(473, 'mainmenu', 'Add Employee', 'add-employee', '', 'employee/add-employee', 'index.php?option=com_chronoforms&view=form', 'component', 1, 471, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"formname":"Employee","event":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 234, 235, 0, '*', 0),
(474, 'mainmenu', 'Add Department', 'add-department', '', 'department/add-department', 'index.php?option=com_chronoforms&view=form', 'component', 1, 472, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"formname":"Department","event":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 240, 241, 0, '*', 0),
(475, 'mainmenu', 'Edit Employees', 'edit-employee', '', 'employee/edit-employee', 'index.php?option=com_chronoforms&view=form', 'component', 1, 471, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"formname":"edit_employee","event":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 236, 237, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_menu_types`
--

CREATE TABLE IF NOT EXISTS `c0n4d_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_menu_types`
--

INSERT INTO `c0n4d_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `c0n4d_messages`
--

CREATE TABLE IF NOT EXISTS `c0n4d_messages` (
...
--
-- Table structure for table `c0n4d_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `c0n4d_messages_cfg` (
...
--
-- Table structure for table `c0n4d_modules`
--

CREATE TABLE IF NOT EXISTS `c0n4d_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_modules`
--

INSERT INTO `c0n4d_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(27, 'Archived Articles', '', '', 1, 'position-3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_articles_archive', 1, 1, '{"count":"10","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
--
-- Table structure for table `c0n4d_modules_menu`
--

CREATE TABLE IF NOT EXISTS `c0n4d_modules_menu` (
...
--
-- Dumping data for table `c0n4d_modules_menu`
--

INSERT INTO `c0n4d_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `c0n4d_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `c0n4d_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `c0n4d_overrider`
--

CREATE TABLE IF NOT EXISTS `c0n4d_overrider` (
...
--
-- Table structure for table `c0n4d_redirect_links`
--

CREATE TABLE IF NOT EXISTS `c0n4d_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `c0n4d_schemas`
--

CREATE TABLE IF NOT EXISTS `c0n4d_schemas` (
...
--
-- Dumping data for table `c0n4d_schemas`
--

INSERT INTO `c0n4d_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.1.5');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_session`
--

CREATE TABLE IF NOT EXISTS `c0n4d_session` (
...
--
-- Dumping data for table `c0n4d_session`
--

INSERT INTO `c0n4d_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('fskihs5tk31neb3t43oj47g6b7', 1, 0, '1383225430', '__default|a:8:{s:15:"session.counter";i:4;s:19:"session.timer.start";i:1383225410;s:18:"session.timer.last";i:1383225419;s:17:"session.timer.now";i:1383225423;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.2; WOW64; rv:25.0) Gecko/20100101 Firefox/25.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"500";s:4:"name";s:13:"Ahumuza Peter";s:8:"username";s:8:"Peter901";s:5:"email";s:19:"hmz2peter@gmail.com";s:8:"password";s:65:"6f791bea2abe89e3769d3aa348395e50:uUzXk7c3cFgRp9qH6JolQ03wMzVJgu1L";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-18 21:29:34";s:13:"lastvisitDate";s:19:"2013-10-31 13:16:43";s:10:"activation";s:1:"0";s:6:"params";s:92:"{"editor":"","timezone":"","language":"","admin_style":"","admin_language":"","helpsite":""}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":6:{s:6:"editor";s:0:"";s:8:"timezone";s:0:"";s:8:"language";s:0:"";s:11:"admin_style";s:0:"";s:14:"admin_language";s:0:"";s:8:"helpsite";s:0:"";}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"7e0c2e8fbe5b7e596f26e3f85b7c1e40";}', 500, 'Peter901'),
('s74qqk5cg3jbg37gddo5g1mp85', 0, 0, '1383225485', '__default|a:8:{s:15:"session.counter";i:6;s:19:"session.timer.start";i:1383225377;s:18:"session.timer.last";i:1383225485;s:17:"session.timer.now";i:1383225485;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.2; WOW64; rv:25.0) Gecko/20100101 Firefox/25.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:6:"return";s:20:"index.php?Itemid=471";s:4:"data";a:0:{}}}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"500";s:4:"name";s:13:"Ahumuza Peter";s:8:"username";s:8:"Peter901";s:5:"email";s:19:"hmz2peter@gmail.com";s:8:"password";s:65:"6f791bea2abe89e3769d3aa348395e50:uUzXk7c3cFgRp9qH6JolQ03wMzVJgu1L";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-18 21:29:34";s:13:"lastvisitDate";s:19:"2013-10-29 17:30:07";s:10:"activation";s:1:"0";s:6:"params";s:92:"{"editor":"","timezone":"","language":"","admin_style":"","admin_language":"","helpsite":""}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":6:{s:6:"editor";s:0:"";s:8:"timezone";s:0:"";s:8:"language";s:0:"";s:11:"admin_style";s:0:"";s:14:"admin_language";s:0:"";s:8:"helpsite";s:0:"";}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"3d6e0016ccea602fbe365363a710346f";}', 500, 'Peter901');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_tags`
--

CREATE TABLE IF NOT EXISTS `c0n4d_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `c0n4d_tags`
--

INSERT INTO `c0n4d_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_template_styles`
--

CREATE TABLE IF NOT EXISTS `c0n4d_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `c0n4d_template_styles`
--

INSERT INTO `c0n4d_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `c0n4d_ucm_base`
--

CREATE TABLE IF NOT EXISTS `c0n4d_ucm_base` (
...
--
-- Table structure for table `c0n4d_ucm_content`
--

CREATE TABLE IF NOT EXISTS `c0n4d_ucm_content` (
...
--
-- Table structure for table `c0n4d_update_sites`
--

CREATE TABLE IF NOT EXISTS `c0n4d_update_sites` (
...
--
-- Dumping data for table `c0n4d_update_sites`
--

INSERT INTO `c0n4d_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1383225424),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1383225424),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1383225424);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `c0n4d_update_sites_extensions` (
...
--
-- Dumping data for table `c0n4d_update_sites_extensions`
--

INSERT INTO `c0n4d_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `c0n4d_updates`
--

CREATE TABLE IF NOT EXISTS `c0n4d_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Available Updates' AUTO_INCREMENT=103 ;

--
-- Dumping data for table `c0n4d_updates`
--

INSERT INTO `c0n4d_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(4, 3, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '3.1.1.2', '', 'http://update.joomla.org/language/details3/ro-RO_details.xml', ''),
(5, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', ''),
(6, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', ''),
(7, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', ''),
(8, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', ''),
(9, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', ''),
(10, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', ''),
(11, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', ''),
(12, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', ''),
(13, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', ''),
(14, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', ''),
(15, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', ''),
(16, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', ''),
(17, 3, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/he-IL_details.xml', ''),
(18, 3, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/he-IL_details.xml', ''),
(19, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', ''),
(20, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', ''),
(21, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', ''),
(22, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', ''),
(23, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', ''),
(24, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', ''),
(25, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', ''),
(26, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', ''),
(27, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', ''),
(28, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', ''),
(29, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', ''),
(30, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', ''),
(31, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', ''),
(32, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', ''),
(33, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', ''),
(34, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', ''),
(35, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', ''),
(36, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
(37, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
(38, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', ''),
(39, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', ''),
(40, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', ''),
(41, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', ''),
(42, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', ''),
(43, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', ''),
(44, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.1.2.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', ''),
(45, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.1.2.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', ''),
(46, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(47, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(48, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(49, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(50, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(51, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(52, 3, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ckb-IQ_details.xml', ''),
(53, 3, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ckb-IQ_details.xml', ''),
(54, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(55, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(56, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(57, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(58, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(59, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(60, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(61, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.1.4.2', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(62, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.1.4.2', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(63, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', ''),
(64, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', ''),
(65, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(66, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(67, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.1.5.3', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
(68, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.1.5.3', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
(69, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', ''),
(70, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', ''),
(71, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.1.2.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', ''),
(72, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.1.2.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', ''),
(73, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.1.5.2', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(74, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.1.5.2', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(75, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.1.4.2', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(76, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.1.4.2', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(77, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
(78, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
(79, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.1.4.4', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', ''),
(80, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.1.4.4', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', ''),
(81, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', ''),
(82, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', ''),
(83, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', ''),
(84, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', ''),
(85, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', ''),
(86, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', ''),
(87, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(88, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(89, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(90, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(91, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(92, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(93, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(94, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(95, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(96, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(97, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', ''),
(98, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', ''),
(99, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(100, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(101, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', ''),
(102, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '');

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_user_notes`
--

CREATE TABLE IF NOT EXISTS `c0n4d_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `c0n4d_user_profiles`
--

CREATE TABLE IF NOT EXISTS `c0n4d_user_profiles` (
...
--
-- Table structure for table `c0n4d_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `c0n4d_user_usergroup_map` (
...
--
-- Dumping data for table `c0n4d_user_usergroup_map`
--

INSERT INTO `c0n4d_user_usergroup_map` (`user_id`, `group_id`) VALUES
(500, 8);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_usergroups`
--

CREATE TABLE IF NOT EXISTS `c0n4d_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `c0n4d_usergroups`
--

INSERT INTO `c0n4d_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `c0n4d_users`
--

CREATE TABLE IF NOT EXISTS `c0n4d_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `c0n4d_users`
--

INSERT INTO `c0n4d_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(500, 'Ahumuza Peter', 'Peter901', 'hmz2peter@gmail.com', '6f791bea2abe89e3769d3aa348395e50:uUzXk7c3cFgRp9qH6JolQ03wMzVJgu1L', 0, 1, '2013-10-18 21:29:34', '2013-10-31 13:16:59', '0', '{"editor":"","timezone":"","language":"","admin_style":"","admin_language":"","helpsite":""}', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `c0n4d_viewlevels`
--

CREATE TABLE IF NOT EXISTS `c0n4d_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `c0n4d_viewlevels`
--

INSERT INTO `c0n4d_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `c0n4d_weblinks`
--

CREATE TABLE IF NOT EXISTS `c0n4d_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
